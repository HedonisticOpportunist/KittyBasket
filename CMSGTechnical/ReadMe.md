...
Below are a number of "tickets" that are needed to bring this site up to "MVP". These are a mix of _features_ and a number of obvious and subtle _bugs_. If you choose to ignore a bug please state the reason.
